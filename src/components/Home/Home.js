  ...
  render() {
    return(
      <div className='main'>
        ...
        <img id='sec-img' src={AltMain} alt="Puppies In Love"/>
        ...
        <p className="sub-text mt-1">A dating app focused on pets? This should have been thought of sooner ...</p>
        <div className='container'>
          <img src={Photo1} className='photo-100' alt=""/>
          <div>
            <i className="fas fa-paw lg-icon pink"></i>
          ...
          <div>
            <i className="fas fa-heart lg-icon pink"></i>            
            <h2 className='sub-heading'>Matching with a fellow <span className='pink'>PET LOVER</span> just makes sense!</h2>
            <p className='sub-text mt-1'>Knowing how special your furry companion is to you why would you waste time with anyone who wouldn't feel the same?</p>
